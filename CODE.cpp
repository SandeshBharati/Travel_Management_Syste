...
public:
    ...
    void hotels()
    {
        string hotelNo[] = {"Pacific Hotel", "Taplejung Guest House", "Sunshine View Hotel"};
        for(int a = 0; a < 3; a++)
        {
        ...
        if(choiceHotel == 1){
            ...
            if (packChoice1 == 1){
                hotelCost = 5000.00;
                cout << "\nYou have successfully booked Standard Pack at Pacific" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 2){
                hotelCost = 10000.00;
                cout << "\nYou have successfully booked Premium Pack at Pacific" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 3){
                hotelCost = 15000.00;
                cout << "\nYou have successfully booked Luxury Pack at Pacific" << endl;
                cout << "Goto Menu to take the receipt" << endl;
            }
            else{
                cout << "Invalid Input! Redirecting to Previous Menu \nPlease Wait!" << endl;
            ...
            cout << "-------WELCOME TO TAPLEJUNG GUEST HOUSE-------\n" << endl;

            cout << "Swimming Pool | Free WiFi | Family Rooms \n Fitness Center | Restaurant & Bar" << endl;

            cout << "Packages Offered by Taplejung Guest House:\n" << endl;
            ...
            if (packChoice1 == 1){
                hotelCost = 15000.00;
                cout << "You have successfully booked Family Pack at Taplejung Guest House" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 2){
                hotelCost = 10000.00;
                cout << "You have successfully booked Couple Pack at Taplejung Guest House" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 3){
                hotelCost = 5000.00;
                cout << "You have successfully booked Single Pack at Taplejung Guest House" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else{
                cout << "Invalid Input! Redirecting to Previous Menu \nPlease Wait!" << endl;
            ...
            cout << "-------WELCOME TO SUNSHINE VIEW HOTEL-------\n" << endl;
            cout << "Set in tropical gardens on the banks of the Indrawati river while Seeing sunshine" << endl;
            ...
            if (packChoice1 == 1){
                hotelCost = 5000.00;
                cout << "You have successfully booked SUNSHINE VIEW Special Pack" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else{
                cout << "Invalid Input! Redirecting to Previous Menu \nPlease Wait!" << endl;
